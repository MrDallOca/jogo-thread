...
(declare jogo-thread-game main-screen text-screen)
...
(defn create-ball-entity!
  [screen]
  (let [ball (texture "resources/ball.png")
...
(defscreen main-screen
  ...
  (fn [screen entities]
    (when-let [entity (first-entity screen entities)]
      (cond
        (:floor? entity)
        (set-screen! jogo-thread-game main-screen text-screen)
        (:block? entity)
